...
export async function getStaticProps({ params }) {
  ...
  const postIndex = allSnippets.findIndex((post) => formatSlug(post.slug) === params.slug.join('/'))
  const prev = allSnippets[postIndex + 1] || null
  const next = allSnippets[postIndex - 1] || null

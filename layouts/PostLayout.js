          ...
          >
            ...
            <footer>
                  ...
                  <div className="flex justify-between py-4 xl:block xl:space-y-8 xl:py-8">
                    {prev && (
                      <div>
                        ...
                        <div className="text-[#007DBC] hover:text-[#00689D] dark:hover:text-[#00689D]">
              ...
              <div className="pt-4 xl:pt-8">
                <Link
                  href="/blog"
                  className="text-[#007DBC] hover:text-[#00689D] hover:underline hover:underline-offset-2 dark:hover:text-[#00689D]"
                >
                  Back to the blog
                </Link>
              </div>
